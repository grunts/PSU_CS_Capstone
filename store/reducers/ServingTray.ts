...
import { ServingTrayState, ServingTrayActionTypes, ADD_ITEM, REMOVE_ITEM } from './types'
...
const servingTrayReducer = (state: ServingTrayState = INITIAL_STATE, action: ServingTrayActionTypes) => {
